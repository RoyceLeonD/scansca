...
func TestDatabaseConnection(t *testing.T) {
	...
	host := os.Getenv("SCANSCA_TEST_DB_HOST")
	port := os.Getenv("SCANSCA_TEST_DB_PORT")
	user := os.Getenv("SCANSCA_TEST_DB_USER")
	password := os.Getenv("SCANSCA_TEST_DB_PASSWORD")
	dbname := os.Getenv("SCANSCA_TEST_DB_NAME")
