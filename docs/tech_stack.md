# Scansca Technology Stack

This document outlines the recommended technology stack for implementing Scansca as an MCP server for database intelligence.
...
Scansca/
├── cmd/
│   └── Scansca-server/       # Main application entry point
│       └── main.go
...
│   └── client/              # Client libraries for Scansca
...
- Use separate database instances for Scansca metadata and monitored databases
